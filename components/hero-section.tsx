...
export default function HeroSection() {
  return (
    <section id="home" className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-br from-blue-50 to-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="max-w-xl">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 magic-reveal show">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button size="lg" variant="outline" className="border-red-600 text-red-600 hover:bg-red-50 magic-hover">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-red-200 rounded-full opacity-70 blur-xl"></div>
            <div className="absolute -top-6 -right-6 w-24 h-24 bg-red-300 rounded-full opacity-70 blur-xl"></div>
          </div>
        </div>
      </div>
    </section>
